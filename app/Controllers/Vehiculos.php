...
class Vehiculos extends BaseController //llamamos la clase cajas
{
    ...
    {
        $this->vehiculos->save(['vehiculos' => $this->request->getPost('vehiculos'), 'maximo' => 
        $this->request->getPost('maximo'), 'tipo_vehiculos' => $this->request->getPost('tipo_vehiculos'), 'empresa' =>
        $this->request->getPost('empresa'), 'clasificacion' => $this->request->getPost('clasificacion')]);
    ...
    {
        $this->vehiculos->update($this->request->getPost('id'), ['vehiculos' =>
        $this->request->getPost('vehiculos'), 'maximo' => $this->request->getPost('maximo'), 
        'tipo_vehiculos' => $this->request->getPost('tipo_vehiculos'), 'empresa' => $this->request->getPost('empresa'),
