                            ...
                            <input type="hidden" id="id" class= "content-center " name="id" value="<?php echo $producto['id']; ?>" />
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" id="tipo" name="tipo" type="text"
                                        value="<?php echo $producto['tipo']; ?>" required />
                                </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" id="vol_m" name="vol_m" type="number"
                                        value="<?php echo $producto['vol_m']; ?>" required />
                                </div>

                                <div class="col-12 col-sm-6">
                                    <label>Peso/total</label>
                                    <input class="form-control" id="peso_total" name="peso_total" type="number"
                                        value="<?php echo $producto['peso_total']; ?>" required />
                                </div>

                                <div class="col-12 col-sm-6">
                                    <label>Ruta de la imagen</label>
                                    <input class="form-control" id="img_productos" name="img_productos" type="text"
                                        value="<?php echo $producto['img_productos']; ?>" required />
                                </div>
