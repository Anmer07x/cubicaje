                            ...
                            <tbody>
                                <?php foreach ($datos as $dato) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url() . '/vehiculos/editar/' . $dato['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i></a></td>

                                        <td><a href="#" data-href="<?php echo base_url() . '/vehiculos/eliminar/' . $dato['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-bs-placement="top" title="Eliminar Registro" class="btn btn-dark"><i class="fas fa-trash-can"></i></a> </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
