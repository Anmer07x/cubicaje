                            ...
                            <tbody>
                                <?php foreach ($datos as $dato) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" data-toggle="modal" data-target="#modelModal" data-id="<?php echo $dato['id']; ?>" class="btn btn-dark">3D</a></td>
    ...
    <div class="modal 3D" id="modelModal" tabindex="-1" aria-labelledby="modelModalLabel" aria-hidden="true">
        <div class="modal-dialog1 modal-lg">
            <div class="modal-content1">
                ...
                <div class="modal-footer">
                    <button type="button" class="btnFooter1" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            // Cuando se hace clic en el botón 'Si', llama a la función para eliminar el vehículo
